import type { ComponentInfo, GrabResult, MatchedCSSRule, StyleUpdateRequest } from "@sakana-y/vue-grab-shared";
 ...
 */
export function wireInspectorEvents(
  container: Element,
  callbacks: InspectorEventCallbacks,
): void {
